...
def test_simulation_bounds():
    ...
    college = CollegeData(college_name = "Fake University", cost_of_attendance = 50000)
    student = StudentProfile(household_income = 50000, total_assets = 100000, family_size = 4, state_of_residence = "NC")
